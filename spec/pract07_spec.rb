...
RSpec.describe List do
	...
	describe "Ordenacion por Listas" do
		it"Ordenacion por for"do
			...
			expect(@paciente1.gasto_energetico_total.round(2)).to eq(1945.9)
			expect(@paciente2.gasto_energetico_total.round(2)).to eq(1681.68)
			expect(@paciente3.gasto_energetico_total.round(2)).to eq(1951.13)
			expect(@paciente4.gasto_energetico_total.round(2)).to eq(6701.75)
			expect(@paciente5.gasto_energetico_total.round(2)).to eq(2474.35)
			expect(@paciente6.gasto_energetico_total.round(2)).to eq(2051.58)
			expect(@paciente7.gasto_energetico_total.round(2)).to eq(2183.5)
